...
| <a name="input_context_template_name"></a> [context\_template\_name](#input\_context\_template\_name) | Name of the context template used to create resource name - this variable is used when, `var.context_templates` is set | `string` | `"snowflake-user"` | no |
