...
| <a name="input_enforce_defaults"></a> [enforce\_defaults](#input\_enforce\_defaults) | Whether to enforce configuration of `default_warehouse` and `default_role` | `bool` | `true` | no |
