...
| <a name="input_first_name"></a> [first\_name](#input\_first\_name) | First name od the user | `string` | `null` | no |
| <a name="input_generate_password"></a> [generate\_password](#input\_generate\_password) | Name of the descriptor used to form a Snowflake User name | `bool` | `false` | no |
